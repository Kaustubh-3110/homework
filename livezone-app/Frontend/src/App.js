...
function App() {
  ...
  const Searchhandlar = () => {
    ...
    if (searchtext.length >= 0) {
      const products = products.filter(products => products.name.toLowerCase().includes(searchtext.toLowerCase()) || products.category.toLowerCase().includes(searchtext.toLowerCase()));
